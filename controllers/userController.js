...
const createNewUser = asyncHandler(async (req, res) => {
  ...
  const userObject =
    !Array.isArray(roles) || !roles.lenght
...
//   console.log(_id +" "+username+" "+ roles +" "+ active)
//   //Confirm Data
//   if (!_id || !username || !roles.length || !Array.isArray(roels) || typeof active !== 'boolean') {
//     return res.status(400).json({ message: "All fields are required" });
//   }

//   //Addig exec() because we are passing a value
...
//   if (duplicate && duplicate?._id_toString() !== _id) {
